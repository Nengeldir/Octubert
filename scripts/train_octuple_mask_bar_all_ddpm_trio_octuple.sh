#!/bin/bash
#SBATCH --job-name=oct_mask_mel
#SBATCH --output=logs/oct_mask_mel_%j.out
#SBATCH --error=logs/oct_mask_mel_%j.err
...
python3 src/smdiff/cli/train.py \
  ...
  --wandb_name "octuple-mask-ddpm-trio-octuple-bar-all"
