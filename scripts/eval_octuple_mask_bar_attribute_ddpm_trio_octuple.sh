#!/bin/bash
#SBATCH --job-name=eval_bar_attr
#SBATCH --output=logs/eval_bar_attr_%j.out
#SBATCH --error=logs/eval_bar_attr_%j.err
...
RUN_DIR="runs/octuple_mask_ddpm_trio_octuple_bar_attribute"
